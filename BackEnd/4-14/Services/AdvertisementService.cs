...
namespace AllEnBackend.Services
{
    public class AdvertisementService : IAdvertisementService
    {
        ...
        // 构造函数
        public AdvertisementService(AppDbContext context, IConfiguration configuration)
        {
            // 连接数据库
        ...
        public async Task<List<Advertisement>> GetAvailableAdAsync()
        {
        ...
        public async Task<List<Material>> GetMaterial(string Id)
        {
